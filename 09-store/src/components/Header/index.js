  ...
  return (
    <header className="text-gray-600 body-font shadow-lg">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <button className="inline-flex items-center text-white bg-indigo-700 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded text-base mt-4 md:mt-0">
          Go to cart
          <svg
            fill="none"
            stroke="currentColor"
